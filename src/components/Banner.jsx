      ...
      <div className="h-full flex items-center justify-center text-center font-bold">
        <div>
          ...
          <div className='flex justify-center items-center'>
            <div className=''>
            <input type='search' name='search' id='' placeholder='Search here' autoComplete='off' className=' outline-none p-3 rounded-lg text-sm relative z-20 border border-black ' onChange={(e)=> dispatch(setSearch(e.target.value))}></input>
            </div>
            <div>
